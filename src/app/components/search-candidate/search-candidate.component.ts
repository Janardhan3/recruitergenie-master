...
onSubmit(){
  ...
  this.apiUrl = "https://recruiter-genie-default-rtdb.firebaseio.com/candidates.json";//firebase database API//
  this.http.get(this.apiUrl).subscribe((res: any) => {
    this.onSerachCandidate=false
    this.result=true
    console.log(res);
    const postArray = Object.keys(res).map(key => ({ ...res[key], id: key })); //to convert to our formate//
...
deleteCandidate(id:number){
  let apiUrl = "https://recruiter-genie-default-rtdb.firebaseio.com/candidates/";
