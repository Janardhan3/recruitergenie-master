...
export class AuthService {
  ...
  signup(email: string, password: string) {
    ...
    return this.http
      .post<AuthResponseData>(
        'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAbUus24Zc9eab4oK_jve2m-BuII6y8wX0',
        {
          email: email,
          password: password,
  ...
  login(email: string, password: string) {
    return this.http
      .post<AuthResponseData>(
        'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAbUus24Zc9eab4oK_jve2m-BuII6y8wX0',
        {
          email: email,
          password: password,
          returnSecureToken: true,
